...
#'   generated by \code{\link[flowCore:logicleTransform]{estimateLogicle}} used
#'   to transform the fluorescent channels of x. TransList is required to apply
...
#' \dontrun{
#' fs <- Activation
#' trans <- estimateLogicle(fs[[2]], getChannels(fs))
#' fs <- transform(fs, trans)
#'
#' computeStats(fs[[1]], channels = c("Alexa Fluor 700-A","Alexa Fluor 488-A","PE-A"), transList = trans, stat = "median")
#' computeStats(fs[[1]], stat = "count")
#' }
#'
#' @export
...
#' fs <- transform(fs, trans)
#'
#' computeStats(fs, channels = c("Alexa Fluor 488-A","PE-A"), transList = trans, stat = "median")
#' computeStats(fs, transList = trans, stat = "geo mean")
#' computeStats(fs, stat = "count")
#' }
#'
#' @export
...
#' gating(gt,gs)
#' 
#' computeStats(gs, alias = "T Cells", channels = c("Alexa Fluor 488-A","PE-A"), stat = "median")
#' computeStats(gs, alias = "T Cells", stat = "geo mean")
#' computeStats(gs, alias = c("CD4 T Cells","CD8 T Cells"), stat = "count")
#' computeStats(gs, alias = c("CD4 T Cells","CD8 T Cells"), parent = c("Live Cells","T Cells"), stat = "freq")
#' }
#'
#' @export
