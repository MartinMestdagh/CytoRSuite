...
**editGate** provides a simple way to modify existing gates applied to the GatingSet and saved to the gatingTemplate csv file. Key features of  **editGate** include:
